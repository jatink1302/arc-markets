    ...
    <DialogPortal>
      ...
      <DialogPrimitive.Popup
        ...
        className={cn(
          ...
          "bg-popover/60 backdrop-blur-2xl backdrop-saturate-200 ring-1 ring-white/15",
          "shadow-[inset_0_1px_0_0_rgba(255,255,255,0.15),0_20px_50px_-12px_rgba(0,0,0,0.5)]",
          className
        )}
        {...props}
      >
